...
def get_pyth_prices(feed_id, start_ts):
    ...
    - start_spot: 30s TWAP opening price (matches Polymarket Price To Beat resolution)
    - live_spot: Instant live Pyth price (catches real-time spot moves & orderbook lag)
    """
    try:
